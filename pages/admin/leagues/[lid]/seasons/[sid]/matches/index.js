          ...
          {matches.length > 0
            ? (
              <table>
                <thead>
                  <tr>
                    <th className={styles.matchDayColumn} scope='col'>MatchDay</th>
                ...
                <tbody>
                  {
                    matches.map((match) => (
                      <tr key={match.MatchId.toString()}>
                        <td className={styles.matchDayColumn}>{match.MatchDay}</td>
                        <td>{convertDateTimeToLocalDateTime(match.StartTime)}</td>
                        <td>{match.HomeTeamName}</td>
                        <td>{match.AwayTeamName}</td>
                        <td className={styles.tableDataCentered}>
                          <Link href={`/admin/leagues/1/seasons/2/matches/${match.MatchId}`}>
                            <a>
