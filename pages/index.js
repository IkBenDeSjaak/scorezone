...
export default function Home () {
  return (
    <Layout>
      ...
      <p className={styles.description}>Compete with your friends and show them who is the best predictor!</p>
      <p className={styles.leagues}>Champions League, World Cup, Premier League, Bundesliga, Primera División, Eredivisie and many more!</p>
